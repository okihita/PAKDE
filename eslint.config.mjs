...
export default tseslint.config(
  ...
  // ── Custom project rules ────────────────────────────────────────
  {
    ...
    rules: {
      ...
      "local/max-lines-per-file": ["error", { max: 500, skip: ["src/data/", "src/features/System/Settings/", "src/features/Business/StoreLayout/", "src/features/System/ProfileSelect/ProfileSelect.tsx", "src/App.tsx"] }],
      // Labels & i18n
