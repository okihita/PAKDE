          ...
          {isAuditing && (
            <div className="space-y-4 font-mono">
              ...
              <div className="h-1 bg-border rounded-full overflow-hidden">
                <div className="h-full bg-warning transition-all duration-150" style={{ width: `${progress}%` }} />
              </div>
            </div>
          )}
          ...
          {auditCompleted && (
            <div className="p-4 rounded-xl border border-success/15 bg-gradient-to-br from-success/5 via-card to-transparent flex flex-col md:flex-row md:items-center justify-between gap-4">
              ...
              <div className="px-5 py-3 rounded-xl bg-success/10 border border-success/20 text-center shrink-0">
                ...
                <span className="text-lg font-black text-success font-mono block mt-1">2,45 : 1</span>
              </div>
            </div>
          )}
        </CardContent>
      ...
      <Card className="bg-card border-border">
        <CardHeader className="pb-3 border-b border-border/55">
          <CardTitle className="text-xs font-bold text-foreground flex items-center gap-2">
            <Chat className="h-3.5 w-3.5 text-info" />
