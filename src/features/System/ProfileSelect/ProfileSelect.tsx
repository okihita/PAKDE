  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-4xl space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-300">
        ...
        {loading ? (
          <div className="text-center py-12 text-xxs font-mono text-muted-foreground">
            {t("common.loading")}
          </div>
        ) : (
                ...
                >
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      <div className="w-8.5 h-8.5 rounded-lg bg-emerald-500/10 flex items-center justify-center border border-emerald-500/10 shrink-0">
                        <Building2 className="h-4 w-4 text-emerald-400" />
                      </div>
                      <span className="text-xxxs font-mono font-bold text-muted-foreground uppercase border border-border/80 px-1.5 py-0.5 rounded bg-input/10">
                        {p.id}
                      </span>
                    </div>
                  ...
                  <div className="space-y-2 pt-4 border-t border-border/40 font-mono text-xxs">
                    <div className="flex justify-between items-center text-xxxs">
                      <span className="text-muted-foreground uppercase">{t("profileSelect.health")}</span>
                    ...
                    <p className="text-xxxs text-muted-foreground mt-1">
                      {t("profileSelect.units")}: <span className="text-foreground font-bold">{uCount}</span>
                    </p>
                  </div>
                </Card>
              );
        ...
        <DialogContent className="bg-card border-border text-foreground max-w-xl max-h-[85vh] overflow-y-auto">
          <form onSubmit={handleCreateSubmit}>
            <DialogHeader>
              ...
              <p className="text-xxs text-muted-foreground mt-0.5 leading-normal">
            ...
            <div className="space-y-4 py-4 text-xs">
              ...
              {/* Officers */}
              <div className="grid grid-cols-2 gap-3.5 border-t border-border/40 pt-3.5">
                <div className="space-y-1">
                  <label className="text-muted-foreground font-mono text-xxxs uppercase">
              ...
              <div className="space-y-2 border-t border-border/40 pt-3.5">
                <label className="text-muted-foreground font-mono text-xxxs uppercase block">
                  {t("profileSelect.units")}
                </label>
                <div className="grid grid-cols-3 gap-3">
                  <label className="flex items-center gap-2 p-2 bg-input/40 border border-border rounded-lg cursor-pointer hover:bg-secondary select-none">
                    <input
                      type="checkbox"
            ...
            <DialogFooter className="border-t border-border/40 pt-3.5">
              <Button
                type="button"
                variant="outline"
                onClick={() => setShowCreateModal(false)}
                className="border-border text-muted-foreground text-xs h-8.5"
              >
                {t("common.cancel")}
              </Button>
              <Button
