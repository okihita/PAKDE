...
To install and run the application, download the latest installer for your operating system from the [Releases](https://github.com/okihita/PAKDE-tauri/releases) page.
